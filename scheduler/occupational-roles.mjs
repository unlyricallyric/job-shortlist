...
export function assessOtherOccupation(record) {
  ...
  const titleRules = [
    ...
    ["professional-marketing", /信息流优化|广告(?:投放|优化|投手)|投放优化|品牌策展|(?:内容|品牌|公关)(?:营销|传播|策划)(?:专家|专员|经理)|品牌活动(?:合作|策划)专家|科技内容传播|新媒体运营|paidmedia(?:manager|specialist)|performancemarketing|publicrelations(?:specialist|manager)/u.test(title)],
