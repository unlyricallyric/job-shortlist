...
宽词采样也沿用已有职能边界：标点拆开的广告/媒介销售、明确直营销售仍按直销判断；真实 JD 以领导日程和内部报表/事务协助为主时，附带“渠道联络”不能变成伙伴发展。伙伴技术产品销售、广告科技伙伴业务、真正伙伴经营中的协调工作及职责未明的卡片分别处理，不依据公司名称或整个客户行业排除；仅有“测试”等简略标题而无可信正文时，也不补推具体专业职责。
